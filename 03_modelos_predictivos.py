...
df = pd.read_csv('/home/claude/datos_luminarias_clinica_alemana.csv',
...
plt.tight_layout()
plt.savefig('/home/claude/03_curvas_supervivencia_km.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('/home/claude/04_evaluacion_modelos.png', dpi=300, bbox_inches='tight')
...
df_operativas_export.to_csv('/home/claude/predicciones_mantenimiento.csv', 
...
df_metricas.to_csv('/home/claude/metricas_modelos.csv', index=False)
