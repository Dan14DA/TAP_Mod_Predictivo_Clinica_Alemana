...
# ============================================================================
# CARGAR DATOS  (Cambiar ruta Local)
# ============================================================================
...
# ============================================================================
# GUARDAR ARCHIVOS (Cambiar Ruta para descarga)
# ============================================================================
...
excel_path = '/home/PowerBI_Dashboard_Data.xlsx'
...
fact_luminarias.to_csv('/home/PowerBI_FACT_Luminarias.csv', index=False, encoding='utf-8-sig')
dim_ubicacion.to_csv('/home/PowerBI_DIM_Ubicacion.csv', index=False, encoding='utf-8-sig')
dim_producto.to_csv('/home/PowerBI_DIM_Producto.csv', index=False, encoding='utf-8-sig')
dim_tiempo.to_csv('/home/PowerBI_DIM_Tiempo.csv', index=False, encoding='utf-8-sig')
fact_mantenimiento.to_csv('/home/PowerBI_FACT_Mantenimiento.csv', index=False, encoding='utf-8-sig')
resumen_metricas.to_csv('/home/PowerBI_Resumen_Metricas.csv', index=False, encoding='utf-8-sig')
