...
# ============================================================================
# 7. EXPORTAR DATOS (Cambiar ruta Local)
# ============================================================================

print("\n[5/5] Exportando archivos...")

# Guardar CSV principal
df_completo.to_csv('/home/datos_luminarias_clinica_alemana.csv', index=False, encoding='utf-8-sig')
print(f"   ✓ Archivo principal: datos_luminarias_clinica_alemana.csv")

# Guardar Excel con múltiples hojas
with pd.ExcelWriter('/home/datos_luminarias_clinica_alemana.xlsx', engine='openpyxl') as writer:
