...
df_proyeccion_compras.to_csv('/home/claude/proyeccion_compras_focos.csv', index=False, encoding='utf-8-sig')
print(f"   ✓ proyeccion_compras_focos.csv")

# 2. Proyección por criticidad
df_criticos_periodo.to_csv('/home/claude/proyeccion_por_criticidad.csv', index=False, encoding='utf-8-sig')
print(f"   ✓ proyeccion_por_criticidad.csv")

# 3. Asignaciones de trabajo
df_asignaciones.to_csv('/home/claude/asignacion_trabajadores.csv', index=False, encoding='utf-8-sig')
print(f"   ✓ asignacion_trabajadores.csv")

# 4. Resumen por trabajador
resumen_trabajadores.to_csv('/home/claude/resumen_trabajadores.csv', index=False, encoding='utf-8-sig')
print(f"   ✓ resumen_trabajadores.csv")

# 5. Excel consolidado
with pd.ExcelWriter('/home/claude/Planificacion_Operativa.xlsx', engine='openpyxl') as writer:
